...
public class ExtConnectionWrapper implements Connection {
	...
	public ExtConnectionWrapper(Connection connection) {
		...
		try {
			...
			throw new RuntimeException("Failed to get or set auto-commit status", e);
		}
	}
	...
	protected void finalize() {
		...
		if (connection != null) {
			try {
				...
				connection.close();
				connection = null;
				logger.warn("ExtConnectionWrapper finalized without being closed. Connection rolled back and closed.");
			} catch (SQLException e) {
	...
	public void close() throws SQLException {
		//connection.close();
		// Do not close the connection here, as it is managed externally
	}
